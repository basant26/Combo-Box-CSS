    ...
    babelHelpers.createClass(DataExporter, [{
        ...
        value: function exportData(data, format, fileName) {
            ...
            switch (format) {
                ...
                case 'jpeg':
                case 'png':
                    that.exportToImage(data, fileName, format);
                    break;
                case 'json':
        ...
        value: function exportToHTML(data, fileName) {
            ...
            if (arguments[2]) {
                var scripts = Array.from(document.getElementsByTagName('script')),
                    html2canvasScript = scripts.find(function (script) {
                    return script.src.indexOf('html2canvas') !== -1;
                });
        ...
        key: 'exportToImage',
        value: function exportToImage(data, fileName, fileExtension) {
            var that = this;
            ...
            var htmlContent = that.exportToHTML(data, fileName, true),
            ...
            function checkIframePopulated() {
                if (!iframe.contentDocument.body || !iframe.contentDocument.body.firstElementChild) {
                    ...
                    iframe.contentWindow.html2canvas(iframe.contentDocument.body.firstElementChild).then(function (canvas) {
                        var draw = new JQX.Utilities.Draw(document.createElement('div'));
        ...
        value: function getAlternationIndex(row, prefix) {
            ...
            if (alternationCount && ((rowsDefinition.alternationStart === undefined || row >= rowsDefinition.alternationStart) && (rowsDefinition.alternationEnd === undefined || row <= rowsDefinition.alternationEnd) || rowsDefinition.alternationStart === rowsDefinition.alternationEnd)) {
        ...
        value: function processRowStyle(style) {
            ...
            for (var i = startIndex; i < that.data.length; i++) {
                ...
                if (rowsDefinition.alternationCount && ((rowsDefinition.alternationStart === undefined || row >= rowsDefinition.alternationStart) && (rowsDefinition.alternationEnd === undefined || row <= rowsDefinition.alternationEnd) || rowsDefinition.alternationStart === rowsDefinition.alternationEnd)) {
