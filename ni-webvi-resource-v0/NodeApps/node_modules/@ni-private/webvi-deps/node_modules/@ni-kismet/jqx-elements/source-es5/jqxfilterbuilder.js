    ...
    babelHelpers.createClass(FilterBuilder, [{
        ...
        */
        ...
        value: function _documentClickHandler(event) {
            ...
            if ((that.isInShadowDOM ? event.composedPath()[0] : event.target).closest('jqx-filter-builder')) {
        ...
        value: function _downHandler(event) {
            ...
            if ((that.shadowRoot || that.isInShadowDOM ? event.composedPath()[0] : event.target).closest('jqx-scroll-bar')) {
        ...
        value: function _generateHTMLStructureFromFlatValue() {
            ...
            var _loop4 = function _loop4(i) {
                var item = that._valueFlat[i],
                    ...
                    parentGroupHTMLcontainer = item.parentId ? (that.shadowRoot || that).querySelector('[node-id="' + item.parentId + '"]').querySelector('.jqx-filter-group-condition-container') : that.$.contentContainer;
        ...
        */
        ...
        value: function _handleContextMenu(target) {
            ...
            if (target.closest('.jqx-filter-add-btn') && that.restrictedMode) {
                that._checkFieldsExistence();
    ...
    babelHelpers.createClass(QueryBuilder, [{
        ...
        value: function propertyChangedHandler(propertyName, oldValue, newValue) {
            ...
            switch (propertyName) {
                ...
                case 'operatorPlaceholder':
                    Array.from((that.shadowRoot || that).querySelectorAll('.jqx-filter-operation[placeholder]')).forEach(function (element) {
                        return element.firstElementChild.innerHTML = newValue;
                    });
                    break;
                case 'propertyPlaceholder':
                    Array.from((that.shadowRoot || that).querySelectorAll('.jqx-filter-field-name[placeholder]')).forEach(function (element) {
                        return element.firstElementChild.innerHTML = newValue;
                    });
                    break;
                case 'showIcons':
                ...
                case 'valuePlaceholder':
                    Array.from((that.shadowRoot || that).querySelectorAll('.jqx-filter-value[placeholder]')).forEach(function (element) {
                        return element.firstElementChild.innerHTML = newValue;
                    });
                    break;
                case 'locale':
        ...
        */
        ...
        value: function _downHandler(event) {
            ...
            var target = that.shadowRoot || that.isInShadowDOM ? event.originalEvent.composedPath()[0] : event.originalEvent.target;
        ...
        value: function _documentMoveHandler(event) {
            ...
            if (!dragDetails.feedbackShown) {
                if (Math.abs(dragDetails.coords.x - event.pageX) > 5 || Math.abs(dragDetails.coords.y - event.pageY) > 5) {
                    ...
                    dragDetails.allConditions = Array.from((that.shadowRoot || that).querySelectorAll('.jqx-filter-group-condition'));
