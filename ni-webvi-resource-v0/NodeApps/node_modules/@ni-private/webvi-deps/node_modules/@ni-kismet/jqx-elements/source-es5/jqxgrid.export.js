    ...
    babelHelpers.createClass(Export, [{
        ...
        value: function exportData(dataFormat) {
                ...
                if (!isHidden) {
                    ...
                    for (var i = 0; i < that.columns.length; i++) {
                        ...
                        if (that.dataExport.view && ['html', 'jpeg', 'pdf', 'png'].indexOf(dataFormat) !== -1 && (column.template || column.formatFunction)) {
                            for (var _i = 0; _i < that.rows.length; _i++) {
                                var cell = that.rows[_i]['column_' + column.dataField];
                                ...
                                columnStyleObject[_i] = cellStyleObject;
                            }
                        }
                    }
            ...
            if (that.dataExport.view) {
                that._recyclingRows.forEach(function (row) {
                    return data.push(row.data);
                });
            } else {
                for (var _i2 = 0; _i2 < viewRows.length; _i2++) {
                    var row = viewRows[_i2];
