...
export class NIPackedComplexSingleAdaptor {
    ...
    static PackDataValue(builder, complexDataToPack) {
        ...
        NIFlatBuffers.PackedData.PackedComplexFloat32Value.addImaginary(builder, complexData.imaginaryPart);
        NIFlatBuffers.PackedData.PackedComplexFloat32Value.addReal(builder, complexData.realPart);
