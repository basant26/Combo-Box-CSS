...
(function () {
    ...
    const jqxColorBox = createElementInformation('jqx-color-picker', 'value', 'change');
    ...
    const jqxComboBoxSelector = createElementInformation('jqx-combo-box', 'value', 'change');
    ...
    function addProperties(proto, elementInfo) {
        proto.clearInstanceSpecificProperties = COMMON_MODULE.generateClearInstanceSpecificProperties();
