...
export class StringControl extends Visual {
    ...
    attachedCallback() {
        ...
        if (firstCall === true) {
            ...
            childElement.addEventListener('scroll', function (evt) {
                that._isScrollingInteractively = that._isMouseDown;
            });
            childElement.addEventListener('mouseup', function (evt) {
                that._isScrollingInteractively = false;
    ...
    /**
     * Vertically scrolls to the end of the text.
     */
    tryScrollToEnd() {
        if (this._isScrollingInteractively === undefined || this._isScrollingInteractively === false) {
