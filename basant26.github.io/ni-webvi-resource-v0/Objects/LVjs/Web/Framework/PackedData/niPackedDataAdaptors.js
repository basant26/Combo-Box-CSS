...
export class NIPackedDataAdaptors {
    ...
    static PackDataValue(builder, dataToPack, niType, packInline, fieldOffset) {
        ...
        switch (niType.getName()) {
            ...
            case NITypeNames.COMPLEXSINGLE:
                dataOffset = NIPackedComplexSingleAdaptor.PackDataValue(builder, dataToPack);
                break;
            case NITypeNames.COMPLEXDOUBLE:
                dataOffset = NIPackedComplexDoubleAdaptor.PackDataValue(builder, dataToPack);
                break;
    ...
    static GetDataAdaptorFromRoot(packedData, niType, options) {
        ...
        switch (niType.getName()) {
            ...
            case NITypeNames.UINT32:
                return new NIPackedValueAdaptor(NIFlatBuffers.PackedData.PackedUInt32Value.getRootAsPackedUInt32Value(buffer), niType, options);
            case NITypeNames.UINT64:
                return new NIPackedLongDataAdaptor(NIFlatBuffers.PackedData.PackedUInt64Value.getRootAsPackedUInt64Value(buffer), niType, options);
            case NITypeNames.INT8:
