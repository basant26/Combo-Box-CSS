...
export class JqxElementCommonModule {
    ...
    // Clear properties that do not apply to cloned template controls, such as niControlId
    static generateClearInstanceSpecificProperties() {
        return function clearInstanceSpecificProperties() {
