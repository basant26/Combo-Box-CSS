        ...
        that.windowEngineCallbacks.setGPropertyValue = function (argsArr) {
            (async function () {
                ...
                try {
                    ...
                    await viModel.processControlUpdateToSetGPropertyValueAsync(controlId, gPropertyName, gPropertyValue);
                }
                catch (error) {
                    /*
