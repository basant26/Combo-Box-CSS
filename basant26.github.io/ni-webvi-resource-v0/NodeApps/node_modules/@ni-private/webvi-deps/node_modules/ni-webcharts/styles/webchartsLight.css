...
_::-webkit-full-page-media, _:future, :root ni-cartesian-graph,
_::-webkit-full-page-media, _:future, :root ni-chart,
_::-webkit-full-page-media, _:future, :root ni-intensity-graph,
_::-webkit-full-page-media, _:future, :root ni-digital-graph {
...
ni-digital-graph text.axisLabels,
.snapshot text.axisLabels {
    font-family: "Open Sans", verdana, arial, sans-serif;
    font-size: 16px;
    fill: purple;
...
ni-chart text.axisLabels,
ni-intensity-graph text.axisLabels,
ni-scatter-graph text.axisLabels,
ni-digital-graph text.axisLabels,
.snapshot text.axisLabels {
    font-family: "Open Sans", verdana, arial, sans-serif;
    font-size: 12px;
...
ni-scatter-graph .flot-x-axis text,
ni-scatter-graph .flot-y-axis text,
ni-digital-graph .flot-x-axis text {
    font-family: "Open Sans", verdana, arial, sans-serif;
    font-size: 16px;
    color: purple;
}
...
ni-scatter-graph .ni-graph-tooltip,
...
.ni-graph-tooltip.on-top {
    transform: translateY(calc(-100% - 10px));
}

.ni-graph-tooltip.on-left {
    transform: translateX(calc(-100% - 10px));
}

.ni-graph-tooltip.on-top.on-left {
