...
JQX('jqx-numeric-text-box', function (_JQX$BaseElement) {
    ...
    babelHelpers.createClass(NumericTextBox, [{
        ...
        value: function ready() {
            ...
            that._positionDetection = new JQX.Utilities.PositionDetection(that, that.$.dropDown, that.$.container, '_closeRadix');
        ...
        value: function _refreshShape() {
            var that = this,
                addons = that.$.container.querySelectorAll('.jqx-numeric-text-box-component:not(.jqx-hidden)');

            Array.from(that.$.container.getElementsByClassName('jqx-numeric-text-box-component')).forEach(function (addon) {
                return addon.classList.remove('jqx-numeric-text-box-component-border-left', 'jqx-numeric-text-box-component-border-right');
            });
        ...
        key: '_closeRadix',
        value: function _closeRadix(forceClose) {
            var that = this,
        ...
        value: function _renderValue(renderedValue, valueInDropDown) {
            ...
            if (valueInDropDown !== true) {
                ...
                if (that.outputFormatString && that._radixNumber === 10) {
                    var activeElement = (that.shadowRoot || that.getRootNode()).activeElement || document.activeElement,
