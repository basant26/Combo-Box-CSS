    ...
    babelHelpers.createClass(ColorPanel, [{
                ...
                case 'editAlphaChannel':
                    {
                        ...
                        var _previousValue2 = that.value;

                        that.value = that._getValue(that.valueFormat);

                        if (that.value !== _previousValue2) {
                            that.$.fireEvent('change', {
                                'oldValue': _previousValue2,
                                'value': that.value
                            });
                        }
                ...
                case that.$.colorPaletteRadial:
                    {
                        ...
                        var previewContainerBottom = (that.shadowRoot || that).querySelector('.preview-container-bottom');
        ...
        */
        ...
        value: function _handleCancelButtonClick(fireClickEvent) {
            ...
            if (that.displayMode === 'palette' || that.displayMode === 'radial') {
                var previewContainerTop = (that.shadowRoot || that).querySelector('.preview-container-top');
        ...
        */
        ...
        value: function _applyValueInPaletteMode(event) {
            ...
            that.$.alphaChannelContainer.style.setProperty('--jqx-color-panel-alpha-channel-color', that._rgbArrayToHEX([that._RGBA.r, that._RGBA.g, that._RGBA.b, 1]));

            if (!that._activeComponent) {
                if (that.$.alphaChannelThumb) {
                    var thumbWidth = that.$.alphaChannelThumb.offsetWidth,
                        scaleWidth = that.$.alphaChannelScale.offsetWidth,
                        _offset = (1 - that._RGBA.a) * scaleWidth > thumbWidth ? (1 - that._RGBA.a) * thumbWidth : 0;

                    that.$.alphaChannelThumb.style.left = (1 - that._RGBA.a) * scaleWidth - _offset + 'px';
                }
        ...
        value: function _applyValueInRadialMode(event) {
            ...
            if (!that._activeComponent) {
                ...
                if (that.$.alphaChannelThumb) {
                    ...
                    that.$.alphaChannelThumb.style.left = (1 - that._RGBA.a) * scaleWidth - offset + 'px';
                }

                var brightness = that.inverted ? that._HSV.v : 1 - that._HSV.v;
        ...
        */
        ...
        value: function _changeSampleSelection(item) {
            ...
            Array.from((that.shadowRoot || that).querySelectorAll('.selected')).forEach(function (item) {
        ...
        */
        ...
        value: function _getRGBAFromInputs() {
            var that = this;
            var r = (that.shadowRoot || that).querySelector('input.r-channel'),
        ...
        value: function _setRGBAToInputs() {
            ...
            Object.entries(that._RGBA).forEach(function (entry) {
                var input = (that.shadowRoot || that).querySelector('input.' + entry[0] + '-channel');
        ...
        */
        ...
        key: 'styleUrls',
        get: function get() {
            return ['jqx.button.css', 'jqx.tooltip.css', 'jqx.colorpanel.css'];
        }
    }]);
    return ColorPanel;
}(JQX.BaseElement));