    ...
    babelHelpers.createClass(Accordion, [{
        ...
        */
        ...
        value: function _downHandler(event) {
            ...
            var target = that.enableShadowDOM && that.shadowRoot ? that.shadowRoot.elementFromPoint(event.pageX, event.pageY) : event.originalEvent.target,
        ...
        */
        ...
        value: function _indexChangeHandler(event) {
            ...
            var itemsReordered = that.enableShadowDOM && that.shadowRoot ? that.shadowRoot.querySelectorAll('jqx-accordion-item') : that.getElementsByTagName('jqx-accordion-item');
        ...
        */
        ...
        value: function _keyDownHandler(event) {
            ...
            var activeElement = (that.shadowRoot ? that.shadowRoot.activeElement : document.activeElement) || document.activeElement;

            if (['ArrowLeft', 'ArrowDown', 'ArrowRight', 'ArrowUp', 'End', 'Home', ' ', 'Enter', 'Tab'].indexOf(keyCode) === -1 || !(activeElement instanceof JQX.AccordionItem)) {
                return;
            }
        ...
        value: function _moveHandler(event) {
            ...
            if (that._dragStart) {
                ...
                if (that.hasAnimation) {
                    var ripple = that._selectedItem.querySelector('.jqx-ripple');
                ...
                var hoveredItem = that._items[inItem];
        ...
        */
        ...
        value: function _reorderItemsByIndex() {
            var that = this;
            var items = that.enableShadowDOM && that.shadowRoot ? that.shadowRoot.querySelectorAll('jqx-accordion-item') : that.getElementsByTagName('jqx-accordion-item'),
