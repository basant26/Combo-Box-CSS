...
JQX('jqx-numeric-text-box', class NumericTextBox extends JQX.BaseElement {
    ...
    template() {
        const template =
            ...
            '</jqx-repeat-button>' +
            '</div>' +
            '<ul id="dropDown" class="jqx-visibility-hidden jqx-drop-down jqx-numeric-text-box-drop-down">' +
    ...
    _refreshShape() {
        ...
        Array.from(that.$.container.getElementsByClassName('jqx-numeric-text-box-component')).forEach(addon => addon.classList.remove('jqx-numeric-text-box-component-border-left', 'jqx-numeric-text-box-component-border-right'));
