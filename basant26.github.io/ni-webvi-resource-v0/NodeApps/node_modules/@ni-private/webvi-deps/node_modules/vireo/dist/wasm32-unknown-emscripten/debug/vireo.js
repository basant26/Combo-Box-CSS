(function (global, factory) {
  ...
  var STACK_BASE = 64432,
      STACK_MAX = 5307312,
      DYNAMIC_BASE = 5307312,
      DYNAMICTOP_PTR = 64176;
  ...
  // {{PRE_LIBRARY}}
    ...
    var ___tm_timezone=(stringToUTF8("GMT", 64320, 4), 64320);function _gmtime_r(time, tmPtr) {
  ...
  var real__TypeRef_TestNeedsUpdateAndReset = asm["_TypeRef_TestNeedsUpdateAndReset"]; asm["_TypeRef_TestNeedsUpdateAndReset"] = function() {
    assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
    assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
    return real__TypeRef_TestNeedsUpdateAndReset.apply(null, arguments);
  };

  var real__TypeRef_TestNeedsUpdateWithoutReset = asm["_TypeRef_TestNeedsUpdateWithoutReset"]; asm["_TypeRef_TestNeedsUpdateWithoutReset"] = function() {
    assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
    assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
    return real__TypeRef_TestNeedsUpdateWithoutReset.apply(null, arguments);
  };
  ...
  var _TypeRef_TestNeedsUpdateAndReset = Module["_TypeRef_TestNeedsUpdateAndReset"] = function() {
    assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
    assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
    return Module["asm"]["_TypeRef_TestNeedsUpdateAndReset"].apply(null, arguments) };
  var _TypeRef_TestNeedsUpdateWithoutReset = Module["_TypeRef_TestNeedsUpdateWithoutReset"] = function() {
    assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
    assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
    return Module["asm"]["_TypeRef_TestNeedsUpdateWithoutReset"].apply(null, arguments) };
